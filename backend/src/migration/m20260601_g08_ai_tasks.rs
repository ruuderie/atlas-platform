        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AtlasAiTasks::InputPayload)
                            .json_binary()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AtlasAiTasks::OutputPayload)
                            .json_binary()
                            .null(),
                    )
                    .col(
                        ColumnDef::new(AtlasAiTasks::SourceEntityType)
                            .string()
                            .null(),
                    )
                    .col(ColumnDef::new(AtlasAiTasks::SourceEntityId).uuid().null())
                    .col(
                        ColumnDef::new(AtlasAiTasks::CallbackEntityType)
                            .string()
                            .null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AtlasAiTasks::Status)
                            .string()
                            .not_null()
                            .default(Expr::val("queued")),
                    )
                    .col(ColumnDef::new(AtlasAiTasks::ErrorMessage).text().null())
                    .col(
                        ColumnDef::new(AtlasAiTasks::RetryCount)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    ...
                    .col(
                        ColumnDef::new(AtlasAiTasks::StartedAt)
                            .timestamp_with_time_zone()
                            .null(),
                    )
                    .col(
                        ColumnDef::new(AtlasAiTasks::CompletedAt)
                            .timestamp_with_time_zone()
                            .null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AtlasAiTasks::EstimatedCostMicroUsd)
                            .integer()
                            .null(),
                    )
                    .to_owned(),
