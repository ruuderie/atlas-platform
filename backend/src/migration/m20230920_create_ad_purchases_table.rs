        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AdPurchase::StartDate)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AdPurchase::EndDate)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AdPurchase::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AdPurchase::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .foreign_key(
