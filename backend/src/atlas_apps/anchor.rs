...
impl AtlasApp for AnchorApp {
    ...
    fn authenticated_router(&self, db: DatabaseConnection) -> Router<DatabaseConnection> {
        Router::new().merge(crate::handlers::anchor::pages::authenticated_routes(db))
    }
    ...
    fn onboarding_steps(&self) -> Vec<OnboardingStep> {
        vec![
            OnboardingStep {
                ...
                description: "Set your site name and tagline so visitors know who you are."
                    .to_string(),
                is_required: true,
                position: 1,
            ...
            OnboardingStep {
                ...
                description: "Connect your domain so your site has its live web address."
                    .to_string(),
                is_required: true,
                position: 2,
            ...
            OnboardingStep {
                ...
                description: "Choose your color palette and typography to match your brand."
                    .to_string(),
                is_required: true,
                position: 3,
                completion_check: StepCompletionCheck::TenantSettingExists {
            ...
            OnboardingStep {
                ...
                description: "Create your home page so your site has something to show visitors."
                    .to_string(),
                is_required: true,
                position: 4,
            ...
            OnboardingStep {
                ...
                description:
                    "Tell us whether your site targets businesses (B2B) or consumers (B2C)."
                        .to_string(),
                is_required: false,
                position: 5,
                completion_check: StepCompletionCheck::TenantSettingExists {
