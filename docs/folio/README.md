...
| Vendor public profile | `docs/private/folio/vendor_public_profile_spec.md` |
| Design preview HTML | `docs/private/folio/design_preview.html` |
...
| What | Path |
|---|---|
| Stitch designs | `designs/stitch/project_pm/folio/` (sibling of repo, not tracked) |
