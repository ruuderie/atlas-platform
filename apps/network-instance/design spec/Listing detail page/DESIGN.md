...
Our typography scale leverages two sans-serifs to distinguish between *brand authority* and *functional utility*.
...
*   **Primary:** Background: `primary` (#004289). Typography: `on-primary` (#ffffff). Shape: `md` (0.375rem). 
    *   *Refinement:* Add a subtle 1px inner-glow (top-down white at 10% opacity) to give the button a tactile, premium feel.
