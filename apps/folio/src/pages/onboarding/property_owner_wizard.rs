...
const STEPS: &[WizardStepDesc] = &[
    WizardStepDesc { id: "details",   label: "Your details",      skippable: false },
    WizardStepDesc { id: "property",  label: "Your property",     skippable: false },
    WizardStepDesc { id: "vendors",   label: "Your vendors",      skippable: true  },
...
pub fn PropertyOwnerWizard() -> impl IntoView {
    ...
    let next_label  = Signal::derive(move || if is_last.get() { "Go to My Dashboard" } else { "Continue" });
