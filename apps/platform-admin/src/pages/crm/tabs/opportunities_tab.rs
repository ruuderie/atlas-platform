...
pub fn OpportunitiesTab() -> impl IntoView {
    ...
    // Client-side filtered + paginated view of deals
                        ...
                        <table>
                            ...
                            <tbody>
                                {rows.into_iter().map(|d| {
                                    ...
                                    let tag_class  = stage_tag_class(&d.stage).to_string();
