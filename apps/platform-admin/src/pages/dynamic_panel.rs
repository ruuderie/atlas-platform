...
pub fn ProfilesPanel() -> impl IntoView {
    view! {
        <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
            <h2 class="text-xl font-semibold mb-4 dark:text-white">"Identity Management"</h2>
            <p class="text-gray-500 dark:text-gray-400">"Users, permissions, and roles mapped to this tenant."</p>
        </div>
    }
}
