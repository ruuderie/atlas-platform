...
pub async fn get_tenant_setting(
    tenant_id: &str,
    key: &str,
) -> Result<super::models::TenantSettingResponse, String> {
    let client = create_client();
    ...
    if res.status() == StatusCode::OK {
        let setting = res
            .json::<super::models::TenantSettingResponse>()
            .await
...
pub async fn upsert_tenant_setting(
    tenant_id: &str,
    req_data: super::models::UpsertSettingRequest,
) -> Result<super::models::TenantSettingResponse, String> {
    let client = create_client();
